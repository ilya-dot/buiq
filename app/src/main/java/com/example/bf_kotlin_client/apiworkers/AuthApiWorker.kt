...
class AuthApiWorker {
    ...
    fun reqisterBuyers(buyer: Buyer, successCallbackFunction: (String?) -> Unit){
    ...
    fun reqisterSellers(buyer: Buyer, successCallbackFunction: (String?) -> Unit){
    ...
    fun updateBuyers(buyer: Buyer,successCallbackFunction: (String?) ->Unit){
        var httpMethod = Request.Method.POST
    ...
    fun updateSellers(buyer: Buyer,successCallbackFunction: (String?) ->Unit){
        var httpMethod = Request.Method.POST
        var url = "http://151.248.113.116:8080/sellers/editBuyer"
        var request = Gson().toJson(buyer)
    ...
    fun getAllBuyers(successCallbackFunction: (String?) -> Unit){
        var httpMethod = Request.Method.GET
        var url = "http://151.248.113.116:8080/sellers/getAllSellers"
